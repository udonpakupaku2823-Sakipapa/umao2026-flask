...
image_files = {
    ...
    "★新着)ＮＨＫマイルＣ": "0510ＮＨＫマイルＣ.png",
    "★新着)エプソムＣ": "0509エプソムＣ.png",
    "★新着)京都新聞杯": "0509京都新聞杯.png",
...
def index():
    ...
    options = ["2026年うま王","2026年うま王収支表（単勝）","2026年うま王収支表（馬連）","2026年うま王収支表（三連複）",
               "★新着)ＮＨＫマイルＣ","★新着)エプソムＣ","★新着)京都新聞杯",
